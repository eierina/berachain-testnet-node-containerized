...
sed $SED_OPT 's|^rpc-dial-url = ".*"|rpc-dial-url = "'http://reth:$EL_AUTHRPC_PORT'"|' "$BEACOND_CONFIG/app.toml"
sed $SED_OPT 's|^laddr = ".*26657"|laddr = "tcp://0.0.0.0:'$CL_ETHRPC_PORT'"|' "$BEACOND_CONFIG/config.toml"
