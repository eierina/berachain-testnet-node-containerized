...
# TODO: restore original url
#curl -s -o "$SEED_DATA_DIR/el-peers.txt" $SEED_DATA_URL/el-peers.txt
curl -s -o "$SEED_DATA_DIR/el-peers.txt" https://raw.githubusercontent.com/berachain/beacon-kit/aad4150cb28b953af199ead908e1bd2b4c01a21a/testing/networks/80069/el-peers.txt
# TODO: restore original url
#curl -s -o "$SEED_DATA_DIR/el-bootnodes.txt" $SEED_DATA_URL/el-bootnodes.txt
curl -s -o "$SEED_DATA_DIR/el-bootnodes.txt" https://raw.githubusercontent.com/berachain/beacon-kit/aad4150cb28b953af199ead908e1bd2b4c01a21a/testing/networks/80069/el-bootnodes.txt
